...
export default function HCVTest() {
  ...
  const handlePrint = () => {
    ...
    const rows: ReportRow[] = [
      { parameterLabel: "Anti-HCV (Qualitative)", value: formData.qualitative || "", normalRange: "Non-reactive", flag: formData.qualitative ? (formData.qualitative === "Non-reactive" ? "NORMAL" : "ABNORMAL") : "" },
    ...
    printLabReport({ reportTitle: "FINAL REPORT", testId: formData.testId, testType: "HCV (Anti-HCV)", patient, rows, comments: formData.comments, minimal: true });
  };

  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-800">HCV (Anti-HCV)</h1>
      </div>
      <Card>
        <CardHeader>
          <CardTitle>New HCV Test</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div>
                <Label className="block text-sm font-medium text-slate-700 mb-2">Anti-HCV (Qualitative)</Label>
